...
In this public repository, the commands in this section assume that you first move into \path{examples/lecture/}. From the repository root, you can also run all tutorial examples with \path{python run_all.py --skip-reference}.
