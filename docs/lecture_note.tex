...
\midrule
OpinionMalware (IEEE TIFS 2025) & Repository \path{OpinionMalware_TIFS_2025_Code}; \path{network.py}, \path{opinionMalware.py}; network construction, normalization, coupled forward malware/opinion dynamics, backward adjoints, impulse strategy search, payoff. & Node-level coupled dynamics with impulses. The hybrid simulation in the companion code is a minimal bridge before reading the full malware-opinion model. \\
...
\begin{figure}[p]
\centering
\includegraphics[width=0.82\textwidth]{../examples/lecture/results/simple_builtin_sf/degree_distribution.png}
...
\vspace{1em}
\includegraphics[width=0.82\textwidth]{../examples/lecture/results/simple_builtin_sf/degree_control_trajectory.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.82\textwidth]{../examples/lecture/results/companion_builtin_sf/degree_game_trajectory.png}
\caption{Degree-$k$ attacker-defender differential game.}
\label{fig:degree-game-output}
\vspace{1em}
\includegraphics[width=0.82\textwidth]{../examples/lecture/results/companion_builtin_sf/hybrid_impulse_trajectory.png}
