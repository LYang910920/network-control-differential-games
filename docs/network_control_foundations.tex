...
\begin{figure}[p]
\centering
\includegraphics[width=0.82\textwidth]{../examples/foundations/results/simple_builtin_sf/degree_distribution.png}
...
\vspace{1em}
\includegraphics[width=0.82\textwidth]{../examples/foundations/results/simple_builtin_sf/degree_control_trajectory.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.82\textwidth]{../examples/foundations/results/companion_builtin_sf/degree_game_trajectory.png}
\caption{Degree-$k$ attacker-defender differential game.}
\label{fig:degree-game-output}
\vspace{1em}
\includegraphics[width=0.82\textwidth]{../examples/foundations/results/companion_builtin_sf/hybrid_impulse_trajectory.png}
