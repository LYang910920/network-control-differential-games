...
The figures below are generated by the two tutorial scripts.  The precise curves depend on the network data, model parameters, normalization convention, and chosen degree definition.
