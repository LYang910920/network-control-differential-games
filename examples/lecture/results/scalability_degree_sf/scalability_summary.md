...
- Network sizes: 100, 200, 300, 500, 1000 nodes.
- Repeats per size: 3.
...
| File | Meaning |
| --- | --- |
| `degree_control_scalability.png` | Runtime and state-dimension/iteration trends as SF network size grows. |
...
At 1000 nodes, the median FBS solve time was 1.881 seconds over 3 repeat(s). All runs at that size converged: True.
