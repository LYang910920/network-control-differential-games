...
| File | Meaning |
| --- | --- |
| `degree_node_fbs_comparison_1000_10000.png` | Paired runtime and state-dimension comparison. |
...
| --- | --- | ---: | ---: | ---: | --- |
| degree | paired_fixed_grid_rk4 | 75 | 24 | 0.299 | True |
| node | paired_sparse_fixed_grid_rk4 | 10000 | 24 | 2.449 | True |
